...
module Greenlight
  class Application < Rails::Application
    ...
    config.help_url = ENV["HELP_URL"].presence || "mailto:360myorg@gmail.com"

    # DEFAULTS

    # Default branding image if the user does not specify one
    config.branding_image_default = "https://fastech-fashions-s3-media-01.s3.ap-south-1.amazonaws.com/images/logo_myorg360.png"
